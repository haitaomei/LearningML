...
def make_mesh(
    ...
    # a 2D mesh is created with two named axes: "data" and "model".
    # - `"data"` axis: Used for data parallelism. The global batch of data is split along this axis.
    # - `"model"` axis: Used for tensor parallelism (a type of model parallelism). 
    #           Individual model weights (tensors) are split across this axis.
    ...
    # )
    # 
    # 8-way tensor parallelism with no data parallelism
